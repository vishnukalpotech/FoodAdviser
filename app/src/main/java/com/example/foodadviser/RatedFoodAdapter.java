...
public class RatedFoodAdapter extends BaseAdapter {
	String [] result,imagesource,images,email,type,details,id,Rids;
    ...
    public RatedFoodAdapter(BestRatedFood useractivity, String[] prgmNameList, String[] prgmImages,String[] restemail,String[] ftype,String[] fdetails,String[] foodid,String[] rid) {
